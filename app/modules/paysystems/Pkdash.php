...
class Pkdash extends \app\modules\Paysystems {
    ...
    public function prepeareMerchant($insert_row) {
        ...
        $res = $paykassa->sci_create_order(
            ...
            'DASH',  // обязательный параметр, валюта, пример: RUB, USD
            ...
            16, // необязательный параметр, указав его Вас минуя мерчант переадресует на платежную систему, пример: 	3 - Qiwi
    ...
    public function doPayment($user_data, $amount, $purse) {
        ...
        $res = $paykassa->api_payment(
            ...
            16,    // обязательный параметр, id платежного метода
            ...
            'DASH',              // обязательный параметр, валюта платежа
