...
class Pkbtc extends \app\modules\Paysystems {

    public $payconfig = [];
    public $installed = true;
    
    public $name = 'pkbtc';
    public $fullname = 'BitCoin';
    ...
    public function prepeareMerchant($insert_row) {
        ...
        $res = $paykassa->sci_create_order(
            ...
            'BTC',  // обязательный параметр, валюта, пример: RUB, USD
            ...
            11, // необязательный параметр, указав его Вас минуя мерчант переадресует на платежную систему, пример: 	3 - Qiwi
    ...
    public function doPayment($user_data, $amount, $purse) {
        ...
        $res = $paykassa->api_payment(
            ...
            11,    // обязательный параметр, id платежного метода
            ...
            'BTC',              // обязательный параметр, валюта платежа
