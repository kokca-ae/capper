...
class Cpdoge extends \app\modules\Paysystems {

    public $payconfig = [];
    public $installed = true;
    public $name = 'cpdoge';
    public $fullname = 'DogeCoin';
    public $url = 'https://www.coinpayments.net';
    public $currs = 'DOGE';
    public $format = '%.8f';
    public $min_insert = 1;
    public $max_insert = 20000;
    public $min_payment = 1;
    public $max_payment = 20000;
    ...
    public function doPayment($user_data, $amount, $purse) {
        ...
        $result = $cps->CreateWithdrawal($amount, 'DOGE', $purse, true);
