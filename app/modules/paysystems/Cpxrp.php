...
class Cpxrp extends \app\modules\Paysystems {

    public $payconfig = [];
    public $installed = true;
    public $name = 'cpxrp';
    public $fullname = 'Ripple';
    ...
    public $regex = '^r[rpshnaf39wBUDNEGHJKLM4PQRST7VWXYZ2bcdeCg65jkm8oFqi1tuvAxyz]{27,35}$';
    public $fields = [
        'sci_id' => [
            'regex' => '/.*/',
            'type' => 'text',
    ...
    public function doPayment($user_data, $amount, $purse) {
        ...
        $result = $cps->CreateWithdrawal($amount, 'XRP', $purse, true);
