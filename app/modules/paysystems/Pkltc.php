...
class Pkltc extends \app\modules\Paysystems {

    public $payconfig = [];
    public $installed = true;
    
    public $name = 'pkltc';
    public $fullname = 'LiteCoin';
    ...
    public function prepeareMerchant($insert_row) {
        ...
        $res = $paykassa->sci_create_order(
            ...
            'LTC',  // обязательный параметр, валюта, пример: RUB, USD
            ...
            14, // необязательный параметр, указав его Вас минуя мерчант переадресует на платежную систему, пример: 	3 - Qiwi
    ...
    public function doPayment($user_data, $amount, $purse) {
        ...
        $res = $paykassa->api_payment(
            ...
            14,    // обязательный параметр, id платежного метода
            ...
            'LTC',              // обязательный параметр, валюта платежа
