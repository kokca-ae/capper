...
class PayKassaSCI {
    ...
    public function __construct($sci_id, $sci_key) {
    ...
    public function sci_create_order($amount, $currency, $order_id = "", $comment = "", $system = 0, $phone = false) {
        $fields = ["amount", "currency", "order_id", "comment", "system", "phone",];
